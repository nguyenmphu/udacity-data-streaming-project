...
```
docker exec -it udacity-data-streaming-project_redis_1 redis-cli
```
...
```
docker exec -it udacity-data-streaming-project_kafka_1 kafka-console-consumer --bootstrap-server localhost:9092 --topic redis-server
```
...
```
docker logs -f udacity-data-streaming-project_stedi_1
```
