...
```
docker exec -it udacity-data-streaming-project-streaming_redis_1 redis-cli
```
...
```
docker exec -it udacity-data-streaming-project-streaming_kafka_1 kafka-console-consumer --bootstrap-server localhost:9092 --topic redis-server
```
...
```
docker logs udacity-data-streaming-project-streaming_spark_1 >& ../spark/logs/spark-master.log

docker logs udacity-data-streaming-project-streaming_spark_1 >& ../spark/logs/spark-master.log >& ../spark/logs/spark-worker.log
```
...
```
docker logs -f udacity-data-streaming-project-streaming_stedi_1
```
